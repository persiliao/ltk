...
# Persi Theme
PERSI_REMOTE=${PERSI_REMOTE:-https://github.com/persiliao/persi-zsh-theme}
PERSI_BRANCH=${PERSI_BRANCH:-master}
PERSI_WORKDIR=${PERSI_WORKDIR:-~/.persi-zsh-theme}
...
setup_persizshtheme() {
  ...
  --depth=1 --branch "${PERSI_BRANCH}" "${PERSI_REMOTE}" "${PERSI_WORKDIR}" || {
